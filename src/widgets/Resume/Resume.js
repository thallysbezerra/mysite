        ...
        <section className="resume">
          ...
          <div className="flex-container">
            ...
            <div className="resume-aside">
              ...
              <ResumeSection icon={data.section[4].icon} title={data.section[4].title}>
                <ul className="resume-list">
                  <li><b>{data.section[4].skills[0].skill}</b></li>
                  <li><b>{data.section[4].skills[1].skill}</b></li>
                  <li><b>{data.section[4].skills[2].skill}</b></li>
                </ul>
              </ResumeSection>
